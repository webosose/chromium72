...
class WamDemoService :
 ...
 private:
  ...
  void LaunchApp(const std::string& value,
                 ...
                 bool shown);
  void OnPerformanceEvent(app_runtime::WebViewBase* window,
  ...
  void OnDidLoadingEnd(app_runtime::WebViewBase* window) override;
  void OnDidFirstPaint(app_runtime::WebViewBase* window) override;
  void OnDidFirstContentfulPaint(app_runtime::WebViewBase* window) override;
  void OnDidFirstTextPaint(app_runtime::WebViewBase* window) override;
  void OnDidFirstImagePaint(app_runtime::WebViewBase* window) override;
  void OnDidFirstMeaningfulPaint(app_runtime::WebViewBase* window) override;
  void OnDidNonFirstMeaningfulPaint(app_runtime::WebViewBase* window) override;
