...
#ifndef NEVA_PC_IMPL_PAL_NATIVE_CONTROLS_INTERFACE_PC_H_
#define NEVA_PC_IMPL_PAL_NATIVE_CONTROLS_INTERFACE_PC_H_
...
#endif  // NEVA_PC_IMPL_PAL_NATIVE_CONTROLS_INTERFACE_PC_H_
