...
var appsDescription = {
  ...
  leftgroup: {
    app_id:       'app17',
    default_url:  'http://@@EMULATOR_SERVER_ADDRESS@@/group.html?x=0&w=520&bk=orange',
    control_name: 'leftgroup.img',
    image_src:    './images/leftgroup.png',
  },
  rightgroup: {
    app_id:       'app18',
    default_url:  'http://@@EMULATOR_SERVER_ADDRESS@@/group.html?x=520&w=1400&bk=green',
    control_name: 'rightgroup.img',
    image_src:    './images/rightgroup.png',
  },
  websocket: {
    app_id:       'app19',
    default_url:  'http://@@EMULATOR_SERVER_ADDRESS@@/websocket.html',
  ...
  use_unlimited_media_policy: {
    app_id:       'app24',
    default_url:  'http://@@EMULATOR_SERVER_ADDRESS@@/use_unlimited_media_policy.html',
...
function callFunc(command, id) {
  ...
  } else if (command == 'firstTextPaintTime') {
    if (typeof(arg) != 'undefined' && node == activeNode)
      document.getElementById('first_text_paint_time').value = arg;
...
function prepareLaunchAppParams(command) {
  ...
  document.getElementById('first_text_paint_time').value = "";
