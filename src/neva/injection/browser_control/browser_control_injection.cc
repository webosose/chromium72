...
void BrowserControlInjectionExtension::Install(
  ...
  if (!gin::Converter<v8::Local<v8::Object>>::FromV8(
          isolate,
          global->Get(gin::StringToV8(isolate, "navigator")),
          &navigator))
    return;
  ...
  auto obj = CreateObject(isolate, navigator);
...
v8::MaybeLocal<v8::Object> BrowserControlInjectionExtension::CreateObject(
  ...
  gin::Handle<BrowserControlInjection> browser_control =
      gin::CreateHandle(isolate, new BrowserControlInjection());
  parent->Set(gin::StringToV8(isolate, "browser_control"),
              browser_control.ToV8());
